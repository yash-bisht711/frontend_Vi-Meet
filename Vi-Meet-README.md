...
1. When a user creates or joins a room, a **unique room ID** is generated.
2. **Socket.io** establishes a WebSocket connection between participants.
3. **WebRTC** handles peer-to-peer video and audio streams.
4. Messages are exchanged through **Socket.io events**.
...
Then set environment variables on your deployment platform.

---

## 📞 Contact

**👤 Author:** [Yash Bisht](https://www.linkedin.com/in/yash-bisht-/)  
📧 **Email:** whyrush711@gmail.com  
📍 **Location:** Bareilly, Uttar Pradesh, India  
💼 **Portfolio:** [https://yash-bisht711.github.io/Yash-Bisht_Portfolio/](https://yash-bisht711.github.io/Yash-Bisht_Portfolio/)  
🐙 **GitHub:** [@yash-bisht711](https://github.com/yash-bisht711)
